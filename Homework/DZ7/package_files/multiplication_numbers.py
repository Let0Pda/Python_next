...
if __name__ == "__main__":
    file1 = r"./Homework/DZ7/dz7_package/adding/adding_to_end.txt"
    file2 = r"./Homework/DZ7/dz7_package/pseudonym.txt"
    res = r"./Homework/DZ7/dz7_package/multiplication_numbers.txt"
